...
class DisplaySettingsAdapter(private val binding : DisplaySettingsDialogBinding) {
    ...
    fun initSettings() {
        ...
        val localNeGeStressToggleDisplayState =
            sharedPreferencesManager.readBoolean(Constants.DisplayState.neStress, true)
        binding.negeToggleDisplaySwitch.isChecked = localNeGeStressToggleDisplayState

        val localDifferentGaugeDisplayState =
            sharedPreferencesManager.readBoolean(Constants.DisplayState.differentGauge, true)
        binding.yachaDisplaySwitch.isChecked = localDifferentGaugeDisplayState

        val localSpare1DisplayState =
            sharedPreferencesManager.readBoolean(Constants.DisplayState.spare1, true)
        binding.spare1DisplaySwitch.isChecked = localSpare1DisplayState

        val localSpare2DisplayState =
            sharedPreferencesManager.readBoolean(Constants.DisplayState.spare2, false)
        binding.spare2DisplaySwitch.isChecked = localSpare2DisplayState

        val localSpare3DisplayState =
            sharedPreferencesManager.readBoolean(Constants.DisplayState.spare3, false)
        binding.spare3DisplaySwitch.isChecked = localSpare3DisplayState

        val localSpare4DisplayState =
            sharedPreferencesManager.readBoolean(Constants.DisplayState.spare4, false)
    ...
    fun saveSettings() {
        ...
        sharedPreferencesManager.writeBoolean(
            Constants.DisplayState.neStress,
            neGeStressDisplayState
        )

        val differentGaugeDisplayState = binding.yachaDisplaySwitch.isChecked
        sharedPreferencesManager.writeBoolean(
            Constants.DisplayState.differentGauge,
            differentGaugeDisplayState
        )
