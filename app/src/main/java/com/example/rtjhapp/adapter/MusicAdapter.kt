...
class MusicAdapter(
    ...
    private val onVolumeChangedListener: (Int) -> Unit) : RecyclerView.Adapter<MusicAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(private val itemBinding: MusicListItemBinding) : RecyclerView.ViewHolder(itemBinding.root) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val itemBinding = MusicListItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
